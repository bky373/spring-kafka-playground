...
import static com.bky373.springkafkaplayground.retry.KafkaRetryConfig.KAFKA_LISTENER_DEFAULT;
...
@Component
public class KafkaListenerDefaultRetryListener extends AbstractConsumerSeekAware {
...
//        if ((value + blockingAttempts) % 2 == 0) {
        throw new SocketException(KAFKA_LISTENER_DEFAULT);
//        }
